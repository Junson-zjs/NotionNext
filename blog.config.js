...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '修行,天善缘,打破无明见真实,破无明,泰国老郑,前世,查事,佛教,泰国老正，泰国世中仙，世中仙', // 网站关键词 英文逗号隔开
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://lf26-cdn-tos.bytecdntp.com/cdn/expire-1-ms/prism/1.27.0/themes/prism-okaidia.css', // 代码块默认主题
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
    'https://lf26-cdn-tos.bytecdntp.com/cdn/expire-1-ms/prism/1.27.0/themes/prism-solarizedlight.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://lf26-cdn-tos.bytecdntp.com/cdn/expire-1-ms/prism/1.27.0/themes/prism-okaidia.min.css', // 深色模式主题
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,line,whatsapp', // 分享的服務，按顺序显示,逗号隔开
