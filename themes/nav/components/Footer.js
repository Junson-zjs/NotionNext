...
const Footer = ({ siteInfo }) => {
  ...
  return (
        ...
        >
            ...
            <div className='text-xs font-serif py-1'>Powered By <a href='https://www.powuming.com/' className='underline text-gray-500 dark:text-gray-300'>打破无明见真实 {siteConfig('VERSION')}</a></div>
